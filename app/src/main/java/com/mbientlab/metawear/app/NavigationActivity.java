...
public class NavigationActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener, ServiceConnection, FragmentBus {
   ...
   Gpio gpioModule;
    ...
    static {
        ...
        tempMap.put(R.id.nav_gpio, ManualControl.class);
...
/*
                ...
                HomeFragment  copyofFragment = (HomeFragment) manager.findFragmentById(R.id.home);

                try {
                    copyofFragment.graphThread.join();
                    copyofFragment.graphThread.interrupt();
                    copyofFragment.graphThread.isInterrupted();
                }
                catch (Exception e) {
                    throw  new RuntimeException("FUCKKK", e);
                }
*/
    ...
    public void onServiceConnected(ComponentName name, IBinder service) {
        ...
        gpioModule.setDigitalOut((byte) 0x05);
        gpioModule.setDigitalOut((byte) 0x06);
        gpioModule.setDigitalOut((byte) 0x07);
...
/*
   gpioModule.clearDigitalOut((byte) 0x05);
       ...
       gpioModule.clearDigitalOut((byte) 0x07);
